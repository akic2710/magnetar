...
| Requirement | Status |
|---|---|
| Gameplay in ≤1 click | Loads directly into a playable tutorial wave; no menu |
| Onboarding inside gameplay | 3-step scripted intro, visual, auto-skipped for returning players |
| 800×450 → 1920×1080 | Fixed 1280×720 virtual canvas, letterboxed scale-to-fit; verified at 531×683 and 800×450 |
| Consistent at 144/165 Hz | Fixed 1/120s accumulator with substep cap; no spiral-of-death |
| No reserved keys | Escape and Ctrl+W unbound |
| International keyboards | Arrows + WASD + ZQSD; blast is radial, so no key needs rebinding |
| Touch | Full parity — drag to move, lift to blast |
| Download size | ~107 KB, one file |
| External requests | **Zero.** Procedural art, WebAudio-synthesised music and SFX |
| Audio | Starts only after a user gesture; mute persists; pauses on blur/hidden |
| PEGI 12 | Abstract neon shapes, no gore, no gambling |
| Original IP | All code, art, and audio generated for this game |
